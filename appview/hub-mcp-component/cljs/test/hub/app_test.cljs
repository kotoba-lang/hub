...
(deftest initialize-db-sets-defaults
  (testing ":initialize-db populates every fact the Svelte scaffold held"
    ...
    (is (= "Hub Mcp Component" @(rf/subscribe [:app/title])))
    (is (= "hub-mcp-component" @(rf/subscribe [:app/name])))
    (is (= "etzhayyim-project-hub" @(rf/subscribe [:app/project])))
    ...
    (is (= "appview/hub-mcp-component/cljs/src/hub/app.cljs"
